...
import { toggleFavorite } from "../../../features/campers/campersSlice";
...
const CamperCard = ({ camper }) => {
  ...
  // Favori durumunu Redux'tan kontrol et
  ...
  const handleFavoriteClick = (e) => {
    e.stopPropagation(); // Kartın tıklanma olayını engellemek için
    ...
    <div className={styles.card}>
      ...
      <div className={styles.content}>
          ...
          <div className={styles.priceWrapper}>
            ...
            >
              <svg 
                ...
                height="24" 
                viewBox="0 0 24 24" 
                fill={isFavorite ? "#E44848" : "none"} // Favori ise kırmızı dolgu
                stroke={isFavorite ? "#E44848" : "#101828"} // Favori ise kırmızı kenarlık
                strokeWidth="2" 
                strokeLinecap="round" 
        ...
        <div className={styles.categories}>
          ...
          {/* ... Petrol Badge ... */}
          <div className={styles.badge}>
            {/* SVG Kodun Aynen Kalıyor */}
            <svg width="20" height="20" viewBox="0 0 20 20" fill="none">
              <path d="M1.25 2.5..." fill="#101828"/> {/* Kısaltılmış temsil */}
            </svg>
          ...
          <div className={styles.badge}>
            {/* SVG Kodun Aynen Kalıyor */}
            <svg width="20" height="20" viewBox="0 0 20 20" fill="none">
               <path d="M17.4875..." fill="#101828"/> {/* Kısaltılmış temsil */}
            </svg>
            <span className={styles.badgeText}>{camper.form}</span>
          </div>
        </div>
